...
>
    ...
    <xsl:variable name="stMes2020">
        <xsl:text>[processImageInline 2020F] Unsupported image file @href='%href'.</xsl:text>
    </xsl:variable>

    <xsl:variable name="stMes2022">
        <xsl:text>[overline 2022W] Microsoft Word does not support inline style: overline. position="'%pos'</xsl:text>
    </xsl:variable>

    <xsl:variable name="stMes2024">
        <xsl:text>[dlhead 2024W] This plug-in does not support dl/dlhead. Use simpletable instead. position="'%pos'</xsl:text>
    </xsl:variable>
    ...
    <xsl:variable name="stMes2500">
        <xsl:text>[simpletable 2500W] Invalid @relcolwidth. It should be the format "N*" value = '%relcolwidth' position='%position'</xsl:text>
    </xsl:variable>
