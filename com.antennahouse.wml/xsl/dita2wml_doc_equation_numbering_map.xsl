...
Making EquationBlock Numbring Tree Templates
**************************************************************
File Name : dita2wml_doc_equation_numbering_map.xsl
**************************************************************
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- fig, table grouping max level
      -->
    <xsl:variable name="cEquationBlockGroupingLevelMax" as="xs:integer">
        <xsl:choose>
            <xsl:when test="$pAddChapterNumberPrefixToEquationNumber">
