...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- 
     ...
     note:		The fn content exists in word/footnote.xml
                ...
                - If @id exists, we should not generate w:footnoteReference here.
                  w:footnoteReference should be generated by the first reference via xref element.
     -->
    <xsl:template match="*[@class => contains-token('topic/fn')]">
